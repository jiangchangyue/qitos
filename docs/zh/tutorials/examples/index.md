...
当前 canonical walkthrough 以英文页为主，但阅读顺序与 QitOS 心智模型保持一致。

推荐阅读顺序：

1. [ReAct Walkthrough](../../../tutorials/examples/react.md)
2. [PlanAct Walkthrough](../../../tutorials/examples/planact.md)
3. [Coding Agent Walkthrough](../../../tutorials/examples/real_coding.md)
4. [SWE Agent Walkthrough](../../../tutorials/examples/real_swe.md)
